            ...
            <nav style="border-bottom: 2px solid white" class="navbar navbar-expand-lg navbar-light bg-light @route('dashboard') d-none @endif" id="darkMode-toggle">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="View Home Page">Home</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('main') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Explore Sneakers">Sneakers</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('comparison') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Compare Shoes">Comparison</a>
                        </li>
                        <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Discover New Shoes">
                        Discover
                        </a>
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('reviews') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Check Web Reviews">Reviews</a>                        
                        </li>
                        <li class="nav-item">
                            <label class="switch">
